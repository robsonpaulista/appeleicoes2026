...
const seedData = async () => {
  try {
    ...
    await pool.query(`
      INSERT INTO whitelist (phone_number, name, role) VALUES
    ...
    await pool.query(`
      INSERT INTO knowledge_base (kb_id, titulo, conteudo, resposta, fonte, tags) VALUES
      ('PROJ-PIAUÍ-001', 'Projeto ECA Digital (PL 2628/2022)', 
       ...
       ARRAY['projetos', 'bandeiras:criancas', 'tema:internet', 'estado:Piauí']),
      ...
      ('REAL-TERESINA-001', 'Realizações em Teresina - Saúde',
       ...
       ARRAY['realizacoes', 'cidade:teresina', 'saude']),
      ...
      ('REAL-PARNAIBA-001', 'Realizações em Parnaíba - Educação',
       ...
       ARRAY['realizacoes', 'cidade:parnaiba', 'educacao']),
    ...
    await pool.query(`
      INSERT INTO canned_responses (key_name, response_text) VALUES
