...
import { configService, whitelistService, knowledgeBaseService, conversationLogService, materiaisService, solicitacoesService, solicitacoesMarketingService, solicitacoesAgendaService, registrosEventosService } from '@/lib/services';
