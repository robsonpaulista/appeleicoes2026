 ...
 */
async function buscarProposicoesPorAutor(idDeputado, tipos, itensPorPagina) {
  const projetos = [];
 ...
 */
async function buscarProposicoesRecentesEVerificarAutores(idDeputado, tipos, itensPorPagina) {
  const projetos = [];
 ...
 */
async function buscarProposicoesPorNome(nomeDeputado, tipos, itensPorPagina) {
  const projetos = [];
 ...
 */
export async function buscarInformacoesDeputado(idDeputado) {
  try {
 ...
 */
export async function buscarProposicoesDoDeputadoEndpoint(idDeputado) {
  try {
